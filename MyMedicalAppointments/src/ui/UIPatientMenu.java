...
public class UIPatientMenu {
    ...
    private static void showBookAppointmentMenu(){
        ...
        do {
            ...
            Scanner sc = new Scanner((System.in));
            Integer responseDataSelected = Integer.valueOf(sc.nextLine());
            Map<Integer, Doctor> docctorAvailableSelect = doctors.get(responseDataSelected);
            Integer indexDate = 0;
            Doctor doctorSelected = new Doctor( "", "");

            for (Map.Entry<Integer, Doctor> doc : docctorAvailableSelect.entrySet()){
